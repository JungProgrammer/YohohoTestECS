...
{
    public class HandObjectsViewsDataStorage : IStorageActions<ItemViewData, ItemType>
    {
        private Dictionary<ItemType, ItemViewData> _data;


        public HandObjectsViewsDataStorage(IAssetsProvider assetsProvider) => 
            Load(assetsProvider);
        ...
        {
            List<ItemViewData> itemsData = assetsProvider.HandObjectsViewsDataCollection.Data;
